        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 sm:mt-0">
            <Link
              href="/cart"
              type="button"
              className="inline-flex items-center px-4 py-2 text-sm font-bold text-gray-600 transition-all duration-200 border-gray-300 rounded-md bg-gray-50 hover:bg- hover:text-gray-900 focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-offset-2 focus:ring-gray-500"
            >
              Edit cart
            </Link>
          </div>
